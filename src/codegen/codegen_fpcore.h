 ...
 * \file codegen_fpcore.h
 * \brief Generate C host code.
 */
#ifndef TVM_CODEGEN_CODEGEN_FPCORE_H_
#define TVM_CODEGEN_CODEGEN_FPCORE_H_
...
class CodeGenFPCore final : public CodeGenC {
 public:
  CodeGenFPCore();
...
#endif  // TVM_CODEGEN_CODEGEN_FPCORE_H_
